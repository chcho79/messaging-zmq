...
class Event : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:emf.Event) */ {
 public:
  Event();
  virtual ~Event();
  ...
  const ::emf::Reading& reading(int index) const;
  ::emf::Reading* mutable_reading(int index);
  ::emf::Reading* add_reading();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::emf::Reading > reading_;
...
class Reading : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:emf.Reading) */ {
 public:
  Reading();
  virtual ~Reading();
